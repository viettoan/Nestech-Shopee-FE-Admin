                            ...
                            <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                                ...
                                <li className="nav-item menu-open menu-is-opening">
                                    <a href="#" className="nav-link active">
                                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 640 512" className="nav-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        <p>
                                            Quản lý Users
                                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 320 512" className="right" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <ul className="nav nav-treeview">
                                        ...
                                        <li className="nav-item">
                                            <NavLink className="nav-link" to={'users/create'} end>
                                                <svg
                                                    stroke="currentColor" fill="currentColor" strokeWidth="0"
                                                    viewBox="0 0 512 512" className="nav-icon" height="1em" width="1em"
                                                    xmlns="http://www.w3.org/2000/svg">
